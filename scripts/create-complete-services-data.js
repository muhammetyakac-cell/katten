...
const items = [
  // --- 9 INDIVIDUAL SERVICES ---
  {
    ...
    highlights: {
      nl: ['1 of 2 bezoeken per dag mogelijk', 'HD Bodycam videobewijs na elk bezoek', 'Persoonlijk dagrapport in het dashboard', 'Geen stress van verhuizing naar pension'],
      en: ['1 or 2 visits per day available', 'HD Bodycam video proof after every visit', 'Personalized daily report in dashboard', 'Zero relocation stress'],
      fr: ['1 ou 2 visites par jour', 'Preuve vidéo Bodycam HD après chaque visite', 'Rapport quotidien sur le tableau de bord', 'Zéro stress de déplacement'],
      tr: ['Günde 1 veya 2 ziyaret seçeneği', 'Her ziyarette HD Yaka Kamerası video kaydı', 'Kullanıcı panelinde günlük rapor', 'Otel stresi olmadan evde bakım']
    },
    image: '/images/cat_feeding.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['dagelijkse kattenoppas Antwerpen', 'huisbezoek kat Antwerpen', 'oppas aan huis kat'],
      en: ['daily cat sitter Antwerp', 'in home cat visit Antwerp'],
      fr: ['visite quotidienne chat Anvers', 'garde chat a domicile Anvers'],
      tr: ['günlük kedi bakıcısı Anvers', 'evde kedi ziyareti Anvers']
    }
  },
  {
    slug: 'feeding',
    ...
    highlights: {
      nl: ['Grondige reiniging van eete- en drinkbakjes', 'Vaste voedingstijden volgens uw instructies', 'Controle op hydratatie en eetlust', 'Geschikt voor medische diëten'],
      en: ['Thorough cleaning of food and water bowls', 'Fixed feeding times per your instructions', 'Appetite and hydration monitoring', 'Suitable for prescription diets'],
      fr: ['Nettoyage complet des gamelles', 'Horaires fixes selon vos instructions', 'Suivi de l\'appétit et de l\'hydratation', 'Adapté aux régimes médicaux'],
      tr: ['Mama ve su kaplarının günlük yıkanması', 'Talimatlarınıza uygun sabit beslenme saatleri', 'İştah ve sıvı alımı takibi', 'Özel veteriner diyetlerine uygunluk']
    },
    image: '/images/cat_feeding.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['katten eten geven oppas Antwerpen', 'vers water kat vakantie', 'voeding kat oppas'],
      en: ['cat feeding service Antwerp', 'cat fresh water sitting Antwerp'],
      fr: ['nourrir chat vacances Anvers', 'alimentation chat garde Anvers'],
      tr: ['kedi mama verme servisi Anvers', 'tatilde kedi besleme Anvers']
    }
  },
  {
    slug: 'medication',
    ...
    highlights: {
      nl: ['Insuline-injecties op strakke 12-uurs intervallen', 'Zachte toediening van pillen zonder stress', 'Biologische en medische achtergrond', 'HD Bodycam videobewijs van toediening'],
      en: ['Insulin injections at precise 12-hour intervals', 'Gentle pill delivery without feline stress', 'Biological and medical background', 'HD Bodycam video proof of administration'],
      fr: ['Injections d\'insuline à intervalle de 12h', 'Administration douce de comprimés sans stress', 'Formation biologique et médicale', 'Preuve vidéo Bodycam HD'],
      tr: ['12 saatlik tam aralıklarla insülin iğnesi', 'Kediyi strese sokmadan nazik hap verme', 'Biyolojik ve medikal tecrübe', 'İlaç anının HD Bodycam kaydı']
    },
    image: '/images/cat_meds.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['kat medicatie toedienen Antwerpen', 'diabetische kat insuline oppas Antwerpen', 'medische kattenoppas'],
      en: ['cat medication sitter Antwerp', 'diabetic cat insulin sitting Antwerp'],
      fr: ['donner medicament chat Anvers', 'insuline chat garde Anvers'],
      tr: ['kedi ilaç verme bakıcısı Anvers', 'diyabetli kedi insülin bakımı Anvers']
    }
  },
  {
    slug: 'bodycam',
    ...
    highlights: {
      nl: ['Volledige HD-opname van het bezoek', 'Discreet en privacy-vriendelijk (enkel voor u)', 'Bekijk beelden binnen 24 uur op uw dashboard', 'Gemoedsrust gegarandeerd tijdens uw vakantie'],
      en: ['Full HD recording of the visit', 'Discreet & privacy compliant (client access only)', 'Watch within 24 hours on your dashboard', 'Guaranteed peace of mind while away'],
      fr: ['Enregistrement HD complet de la visite', 'Confidentiel et sécurisé (accès client uniquement)', 'Disponible sous 24h sur votre espace', 'Sérénité garantie pendant vos vacances'],
      tr: ['Ziyaretin eksiksiz HD video kaydı', 'Gizlilik odaklı (sadece sizin erişiminize açık)', '24 saat içinde panelde izleme imkanı', 'Seyahatinizde %100 kafa rahatlığı']
    },
    image: '/images/cat_bodycam.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['bodycam kattenoppas Antwerpen', 'transparante kattenoppas', 'videobewijs oppas kat'],
      en: ['bodycam cat sitter Antwerp', 'transparent pet sitting Antwerp'],
      fr: ['bodycam garde chat Anvers', 'camera video cat sitter Anvers'],
      tr: ['yaka kameralı kedi bakıcısı Anvers', 'videolu kedi bakıcı Anvers']
    }
  },
  {
    slug: 'health',
    ...
    highlights: {
      nl: ['Biyolojik uzmanlık met diergeneeskundige inzichten', 'Dagelijkse inspectie van kattenbak en eetlust', 'Direct contact bij afwijkingen of spoed', 'Samenwerking met lokale dierenartsen in Antwerpen'],
      en: ['Biological expertise with veterinary awareness', 'Daily check of appetite and litter habits', 'Immediate client alert upon any medical concern', 'Partnerships with local Antwerp vet clinics'],
      fr: ['Expertise biologique et sensibilité vétérinaire', 'Vérification quotidienne du comportement', 'Alerte immédiate en cas de souci', 'Partenariat avec vétérinaires locaux'],
      tr: ['Biyoloji ve veteriner bilinciyle takip', 'Günlük iştah ve kum kontrolü', 'Sorun anında derhal kullanıcıya bildirim', 'Anvers veteriner klinikleriyle koordinasyon']
    },
    image: '/images/cat_health.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['gezondheidscontrole kat oppas Antwerpen', 'bioloog kattenzorg Antwerpen', 'zieke kat oppas'],
      en: ['cat health monitoring Antwerp', 'biologist cat care Antwerp'],
      fr: ['suivi sante chat Anvers', 'biologiste garde chat Anvers'],
      tr: ['kedi sağlık takibi Anvers', 'biyolog kedi bakıcısı Anvers']
    }
  },
  {
    slug: 'litter',
    ...
    highlights: {
      nl: ['Grondig scheppen bij elk bezoek', 'Netjes aanvegen van de uitloopruimte', 'Volledige verschoonservice mogelijk', 'Voorkomt nare geurtjes in huis'],
      en: ['Thorough scooping every visit', 'Sweeping litter scatter around the box', 'Full litter refresh option available', 'Keeps your home smelling fresh'],
      fr: ['Nettoyage complet à chaque visite', 'Balayage autour du bac', 'Changement complet de litière possible', 'Élimine les mauvaises odeurs'],
      tr: ['Her ziyarette detaylı kum eleme', 'Kum kabı etrafının süpürülmesi', 'Komple kum değiştirme seçeneği', 'Evinizde kötü kokuları önleme']
    },
    image: '/images/cat_plants.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['kattenbak schoonmaken oppas Antwerpen', 'kattenbak hygiene vakantie'],
      en: ['litter box cleaning Antwerp', 'cat litter sitter Antwerp'],
      fr: ['nettoyage litiere chat Anvers'],
      tr: ['kedi kumu temizliği Anvers', 'kedi kum kabı bakımı']
    }
  },
  {
    slug: 'playtime',
    ...
    highlights: {
      nl: ['Speelhengel en puzzelspeelgoed inbegrepen', 'Aangepast aan de energie van uw kat (kitten vs senior)', 'Vermindert scheidingsangst en verveling', 'HD Bodycam beelden van de speelsessie'],
      en: ['Feather wands and puzzle toys included', 'Tailored to your cat\'s energy level (kitten vs senior)', 'Reduces separation anxiety and boredom', 'HD Bodycam footage of play sessions'],
      fr: ['Jeux et jouets interactifs inclus', 'Adapté à l\'énergie de votre chat', 'Réduit l\'anxiété de séparation', 'Vidéos Bodycam des moments de jeu'],
      tr: ['Oyun oltaları ve zeka oyuncakları dahil', 'Kedinizin enerjisine özel oyun (yavru vs yaşlı)', 'Ayrılık kaygısı ve sıkıntıyı azaltma', 'Oyun anlarının HD Bodycam kaydı']
    },
    image: '/images/cat_playing.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['kat spelen oppas Antwerpen', 'aandacht kat vakantie', 'kat knuffelen oppas'],
      en: ['cat playtime sitter Antwerp', 'cat affection pet sitter Antwerp'],
      fr: ['jeux chat garde Anvers', 'calins chat oppas Anvers'],
      tr: ['kedi oyun saati bakıcı Anvers', 'kedi sevgi bakımı Anvers']
    }
  },
  {
    slug: 'plants',
    ...
    highlights: {
      nl: ['Inbegrepen bij Standaard en Premium plannen', 'Gieten volgens uw specifieke instructies', 'Zowel kamerplanten als terras/balkonplanten', 'U komt thuis bij een groen huis'],
      en: ['Included with Standard and Premium plans', 'Watered according to your exact notes', 'Both indoor and balcony/garden plants', 'Return home to thriving green plants'],
      fr: ['Inclus dans les forfaits Standard et Premium', 'Arrosage selon vos consignes', 'Plantes d\'intérieur et de balcon', 'Retrouvez un intérieur verdoyant'],
      tr: ['Standart ve Premium paketlerimize dahil', 'Çiçeklerinize özel sulama talimatlarına uyum', 'Hem salon hem balkon/teras bitkileri', 'Yeşil ve canlı bir eve dönüş']
    },
    image: '/images/cat_plants.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['planten water geven vakantie Antwerpen', 'oppas planten en katten Antwerpen'],
      en: ['plant watering pet sitter Antwerp', 'house sitting plant care Antwerp'],
      fr: ['arrosage plantes vacances Anvers'],
      tr: ['tatilde çiçek sulama Anvers', 'evde bitki sulama bakıcısı']
    }
  },
  {
    slug: 'mail',
    ...
    highlights: {
      nl: ['Post en pakketjes veilig uit het zicht gelegd', 'Inbraakpreventie: gordijnen & lichten bedienen', 'Vuilnisbakken buitenzetten op ophaaldagen', 'Geen extra kosten'],
      en: ['Mail and packages safely stored out of sight', 'Burglary prevention: adjust blinds & lights', 'Trash bin put-out on collection days', 'No additional charges'],
      fr: ['Courrier mis en sécurité à l\'abri des regards', 'Prévention cambriolage: volets et lumières', 'Sortie des poubelles les jours de collecte', 'Sans supplément'],
      tr: ['Posta ve kargoların güvenle gözden uzak konması', 'Hırsızlık önleme: perde ve ışık hareketi', 'Çöp toplama gününde kutuları dışarı çıkarma', 'Ekstra ücret yok']
    },
    image: '/images/cat_security.png',
    geo: { latitude: 51.2194, longitude: 4.4025 },
    keywords: {
      nl: ['post ophalen vakantie Antwerpen', 'inbraakpreventie oppas Antwerpen'],
      en: ['mail collection pet sitter Antwerp', 'burglary prevention house sitting Antwerp'],
      fr: ['releve courrier vacances Anvers'],
      tr: ['tatilde posta toplama Anvers', 'ev güvenlik kedi bakıcı']
    }
  },

  // --- 5 DISTRICT LANDING PAGES ---
  {
    slug: 'antwerpen-zuid',
    ...
    highlights: {
      nl: ['Snelle sleuteloverdracht in postcode 2000 & 2018', 'HD Bodycam videobewijs na elk bezoek', 'Biologische en medical uzmanlık', 'Planten water geven en post verzamelen inbegrepen'],
...
const file = 'src/lib/district-data.ts';
let code = `export interface DistrictInfo {
  slug: string;
  postalCode: string;
...
export const districts: DistrictInfo[] = ${JSON.stringify(items, null, 2)};
...
console.log(`Successfully generated complete services & districts data with ${items.length} total pages!`);
