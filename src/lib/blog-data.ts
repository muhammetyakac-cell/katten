...
Bij **KattenHond** in Antwerpen bieden we professionele kattenoppasdiensten aan huis. Dit betekent dat uw kat in zijn eigen vertrouwde omgeving blijft. Wij komen langs om te voeren, te spelen en eventuele medische zorg te bieden, gebaseerd op onze biologische expertise.
...
Meer weten over onze aanpak? Bekijk onze [Diensten](/nl/diensten) of neem direct [Contact](/nl/contact) op voor een kennismaking in regio Antwerpen.`,
    ...
    seoTitle: "Waar Kat Achterlaten Vakantie | KattenHond Antwerpen",
...
Want to know more? Check our [Services](/en/services) or [Contact](/en/contact) us directly for a meet-and-greet in the Antwerp area.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_feeding.png",
    seoTitle: "Where to Leave Cat Vacation | KattenHond Antwerp",
...
Intéressé ? Consultez nos [Services](/fr/services) ou prenez [Contact](/fr/contact) dans la région d\'Anvers.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_feeding.png",
    seoTitle: "Où Laisser Son Chat Vacances | KattenHond Anvers",
...
Daha fazlasını öğrenmek ister misiniz? [Hizmetlerimize](/tr/hizmetler) göz atın veya Anvers bölgesinde bir tanışma için [İletişime](/tr/iletisim) geçin.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_feeding.png",
    seoTitle: "Tatilde Kedimi Nereye Bırakmalıyım | KattenHond Anvers",
...
Boek vandaag nog een kennismakingsgesprek via onze [Contactpagina](/nl/contact).`,
    ...
    seoTitle: "Hoe Kattenoppas Vinden | KattenHond Antwerpen",
...
Book a meet-and-greet today via our [Contact page](/en/contact).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_bodycam.png",
    seoTitle: "How to Find Cat Sitter | KattenHond Antwerp",
...
Réservez une rencontre dès aujourd'hui via notre [page Contact](/fr/contact).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_bodycam.png",
    seoTitle: "Trouver Cat Sitter | KattenHond Anvers",
...
[İletişim sayfamız](/tr/iletisim) üzerinden bugün bir tanışma randevusu alın.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_bodycam.png",
    seoTitle: "Kedi Bakıcısı Nasıl Bulunur | KattenHond Anvers",
...
Laat de zorg voor uw kat niet over aan het toeval. Bij **KattenHond** in Antwerpen garanderen wij liefdevolle en professionele zorg. Lees meer over onze [Diensten](/nl/diensten).`,
    date: "2026-06-15",
    readTime: "2 min",
    author: "KattenHond Team",
    image: "/images/cat_playing.png",
    seoTitle: "Mensen Gezocht Kat Bezoeken | KattenHond Antwerpen",
...
Don't leave your cat's care to chance. At **KattenHond** in Antwerp, we guarantee loving and professional care. Learn more about our [Services](/en/services).`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_playing.png",
    seoTitle: "People to Visit My Cat | KattenHond Antwerp",
...
Ne laissez pas les soins de votre chat au hasard. Chez **KattenHond** à Anvers, nous garantissons des soins aimants et professionnels. Découvrez nos [Services](/fr/services).`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_playing.png",
    seoTitle: "Cherche Personne Visiter Chat | KattenHond Anvers",
...
Kedinizin bakımını şansa bırakmayın. Anvers'teki **Katten**'de sevgi dolu ve profesyonel bakımı garanti ediyoruz. [Hizmetlerimiz](/tr/hizmetler) hakkında daha fazla bilgi edinin.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_playing.png",
    seoTitle: "Kedimi Ziyaret Edecek Kişi | KattenHond Anvers",
...
Bij **KattenHond** onderscheiden we ons door onze wetenschappelijke achtergrond. U betaalt niet zomaar voor iemand die de deur opent; u investeert in de expertise van een bioloog. 
...
Hoewel een buurman misschien goedkoper (of gratis) is, dekt een professionele service onvoorziene medische situaties en garandeert het de hoogste standaard van welzijn. Voor specifieke tarieven in de regio Antwerpen, kunt u terecht op onze [Diensten](/nl/diensten) pagina of contacteer ons via de [Contact](/nl/contact) pagina voor een offerte op maat.`,
    ...
    seoTitle: "Kosten Kattenoppas Antwerpen | KattenHond Prijzen",
...
At **KattenHond**, we stand out due to our scientific background. You are not just paying for someone to open the door; you are investing in the expertise of a biologist.
...
While a neighbor might be cheaper, a professional service handles unforeseen medical situations and guarantees the highest standard of welfare. For specific rates in the Antwerp area, visit our [Services](/en/services) page or [Contact](/en/contact) us for a custom quote.`,
    ...
    author: "KattenHond Team",
    image: "/images/hero_background.png",
    seoTitle: "Cost of Cat Sitting Antwerp | KattenHond Prices",
...
Chez **KattenHond**, nous nous démarquons par notre profil scientifique. Vous ne payez pas seulement pour quelqu'un qui ouvre la porte ; vous investissez dans l'expertise d'un biologiste.
...
Bir komşu daha ucuz olsa da, profesyonel bir hizmet öngörülemeyen tıbbi durumları yönetir ve en yüksek refah standardını garanti eder. Anvers bölgesindeki özel fiyatlar için [Hizmetler](/tr/hizmetler) sayfamızı ziyaret edin veya özel bir teklif için bizimle [İletişime](/tr/iletisim) geçin.`,
    ...
    author: "KattenHond Team",
    image: "/images/hero_background.png",
    seoTitle: "Kedi Bakım Maliyeti Anvers | KattenHond Fiyatları",
...
Bij **KattenHond** zijn onze oppasbezoeken zo ontworpen dat we actief letten op deze stresssignalen. Wij zorgen voor een kalmerende omgeving en passen onze interactie aan op het stressniveau van het dier. Woont u in Antwerpen en heeft u een angstige kat? Neem [Contact](/nl/contact) met ons op voor gespecialiseerde zorg.`,
    date: "2026-06-25",
    readTime: "2 min",
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_meds.png",
    seoTitle: "Stress Bij Katten Herkennen | KattenHond Antwerpen",
...
At **KattenHond**, our sitting visits are designed to actively monitor for these stress signals. We provide a calming environment and adjust our interactions based on the animal's stress levels. Live in Antwerp and have an anxious cat? [Contact](/en/contact) us for specialized care.`,
    date: "2026-06-25",
    readTime: "2 min",
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_meds.png",
    seoTitle: "Recognizing Cat Stress | KattenHond Antwerp",
...
Chez **KattenHond**, nos visites sont conçues pour repérer activement ces signaux. Nous offrons un environnement apaisant à Anvers. Vous avez un chat anxieux ? Prenez [Contact](/fr/contact) pour des soins spécialisés.`,
    date: "2026-06-25",
    readTime: "2 min",
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_meds.png",
    seoTitle: "Reconnaître Stress Chat | KattenHond Anvers",
...
**Katten**'de, bakım ziyaretlerimiz bu stres sinyallerini aktif olarak izlemek üzere tasarlanmıştır. Anvers'te sakinleştirici bir ortam sağlıyoruz. Endişeli bir kediniz mi var? Uzman bakımı için bizimle [İletişime](/tr/iletisim) geçin.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_meds.png",
    seoTitle: "Kedi Stres Belirtileri | KattenHond Anvers",
...
Met de diensten van **Katten** in Antwerpen hoeft u zich geen zorgen te maken. We documenteren elk bezoek via een bodycam, zodat u letterlijk met ons meekijkt. Ontdek meer via onze [Diensten](/nl/diensten) pagina.`,
    ...
    seoTitle: "Kat Alleen Thuis Vakantie | KattenHond Antwerpen",
...
With **Katten's** services in Antwerp, you don't have to worry. We document every visit via a bodycam, so you can literally watch along with us. Discover more via our [Services](/en/services) page.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_security.png",
    seoTitle: "Cat Home Alone Holiday | KattenHond Antwerp",
...
Avec les services de **Katten** à Anvers, ne vous inquiétez plus. Nous filmons chaque visite avec une bodycam. Découvrez-en plus sur notre page [Services](/fr/services).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_security.png",
    seoTitle: "Chat Seul Maison Vacances | KattenHond Anvers",
...
Anvers'teki **Katten** hizmetleriyle endişelenmenize gerek yok. Her ziyareti yaka kamerası (bodycam) ile belgeliyoruz, böylece adeta bizimle birlikte izleyebilirsiniz. [Hizmetler](/tr/hizmetler) sayfamızdan daha fazlasını keşfedin.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_security.png",
    seoTitle: "Tatilde Kedim Evde Yalnız | KattenHond Anvers",
...
Kies voor zekerheid tijdens uw afwezigheid in Antwerpen. Onze wetenschappelijke benadering garandeert dat gezondheidsproblemen snel worden opgemerkt. Neem [Contact](/nl/contact) op voor meer informatie.`,
    ...
    seoTitle: "Gezondheidscheck Katten Tips | KattenHond Antwerpen",
...
Choose certainty during your absence in Antwerp. Our scientific approach ensures that health issues are spotted quickly. [Contact](/en/contact) us for more information.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_health.png",
    seoTitle: "Cat Health Check Tips | KattenHond Antwerp",
...
Choisissez la certitude pendant votre absence à Anvers. Notre approche scientifique garantit une détection rapide des problèmes. Prenez [Contact](/fr/contact) avec nous.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_health.png",
    seoTitle: "Bilan Santé Chat | KattenHond Anvers",
...
Anvers'teki yokluğunuzda kesinliği seçin. Bilimsel yaklaşımımız, sağlık sorunlarının hızlı bir şekilde fark edilmesini sağlar. Daha fazla bilgi için bizimle [İletişime](/tr/iletisim) geçin.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_health.png",
    seoTitle: "Kedi Sağlığı Kontrolü | KattenHond Anvers",
...
Besides nutrition, as a pet sitting service in Antwerp, we also check your home for toxic plants (like lilies) and ensure the feeding routine is strictly followed during your absence. At **KattenHond**, we weigh portions and closely monitor eating behavior. Want to know more? Check our [Services](/en/services).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_plants.png",
    seoTitle: "Cat Nutrition Guide | KattenHond Antwerp",
...
En plus de la nutrition, notre service à Anvers vérifie votre maison pour les plantes toxiques (comme les lys). Chez **KattenHond**, nous pesons les portions et surveillons le comportement alimentaire. Découvrez nos [Services](/fr/services).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_plants.png",
    seoTitle: "Alimentation Pour Chats | KattenHond Anvers",
...
Beslenmenin yanı sıra, Anvers'te bir kedi bakım servisi olarak evinizi zehirli bitkiler (zambak gibi) açısından da kontrol ediyor ve yokluğunuzda beslenme rutininin sıkı bir şekilde izlenmesini sağlıyoruz. **Katten**'de porsiyonları tartar ve yeme davranışlarını yakından izleriz. Daha fazlasını öğrenmek ister misiniz? [Hizmetlerimize](/tr/hizmetler) göz atın.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_plants.png",
    seoTitle: "Kedi Beslenmesi Rehberi | KattenHond Anvers",
...
Moet u onverwacht weg en heeft u een kitten thuis in Antwerpen? Bij **KattenHond** bieden we speciale kitten-care bezoeken aan, inclusief extra speel- en knuffeltijd voor de juiste socialisatie. Bekijk onze [Diensten](/nl/diensten) voor meer details.`,
    date: "2026-07-15",
    readTime: "2 min",
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_emergency.png",
    seoTitle: "Kitten Verzorging Tips | KattenHond Antwerpen",
...
Need to leave unexpectedly and have a kitten at home in Antwerp? At **KattenHond**, we offer special kitten-care visits, including extra playtime and cuddling for proper socialization. Check our [Services](/en/services) for more details.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_emergency.png",
    seoTitle: "Kitten Care Tips | KattenHond Antwerp",
...
Vous devez vous absenter de votre domicile à Anvers ? Chez **KattenHond**, nous proposons des visites spéciales pour chatons avec du temps de jeu supplémentaire. Découvrez nos [Services](/fr/services).`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_emergency.png",
    seoTitle: "Conseils Soins Chatons | KattenHond Anvers",
...
Beklenmedik bir şekilde gitmeniz mi gerekiyor ve Anvers'teki evinizde bir yavru kediniz mi var? **Katten**'de, uygun sosyalleşme için ekstra oyun zamanı ve sarılma içeren özel yavru kedi bakım ziyaretleri sunuyoruz. Daha fazla ayrıntı için [Hizmetlerimizi](/tr/hizmetler) inceleyin.`,
    ...
    author: "KattenHond Biologist - Biyolog",
    image: "/images/cat_emergency.png",
    seoTitle: "Yavru Kedi Bakımı İpuçları | KattenHond Anvers",
...
Als u in Antwerpen woont, kan **Katten** helpen. Onze bezoeken zijn gericht op het doorbreken de cyclus van eenzaamheid met interactief spel en geruststellende aanwezigheid, gedocumenteerd met onze bodycam. Neem [Contact](/nl/contact) met ons op voor een aanpak op maat.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_bodycam.png",
    seoTitle: "Verlatingsangst Bij Katten | KattenHond Antwerpen",
...
If you live in Antwerp, **Katten** can help. Our visits aim to break the cycle of loneliness with interactive play and reassuring presence, all documented with our bodycam. [Contact](/en/contact) us for a tailored approach.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_bodycam.png",
    seoTitle: "Separation Anxiety in Cats | KattenHond Antwerp",
...
Si vous habitez Anvers, **Katten** peut vous aider. Nos visites visent à rompre la solitude avec des jeux interactifs et une présence rassurante, documentée par bodycam. [Contactez-nous](/fr/contact) pour une approche sur mesure.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_bodycam.png",
    seoTitle: "Anxiété Séparation Chat | KattenHond Anvers",
...
Anvers'te yaşıyorsanız, **Katten** size yardımcı olabilir. Ziyaretlerimiz, yaka kameramızla belgelenen interaktif oyunlar ve güven verici bir varlık ile yalnızlık döngüsünü kırmayı amaçlamaktadır. Özel bir yaklaşım için bizimle [İletişime](/tr/iletisim) geçin.`,
    ...
    author: "KattenHond Team",
    image: "/images/cat_bodycam.png",
    seoTitle: "Kedilerde Ayrılık Anksiyetesi | KattenHond Anvers",
  ...
  },
  {
    ...
    "date": "2026-07-21",
    "readTime": "3 min",
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_security.png",
    "seoTitle": "Kattenoppas Antwerpen Zuid, Centrum, Berchem & Deurne | KattenHond",
...
},
  {
    ...
    "date": "2026-07-21",
    "readTime": "3 min",
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_security.png",
    "seoTitle": "Cat Sitter Antwerp Zuid, City Centre, Berchem & Deurne | KattenHond",
...
},
  {
    ...
    "date": "2026-07-21",
    "readTime": "3 min",
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_security.png",
    "seoTitle": "Garde de Chat Anvers Zuid, Centre, Berchem & Deurne | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_security.png",
    "seoTitle": "Anvers Kedi Bakıcısı Zuid, Merkez, Berchem & Deurne | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_health.png",
    "seoTitle": "Cat Hotel vs In-Home Cat Sitter Antwerp | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_health.png",
    "seoTitle": "Hôtel pour Chats vs Garde à Domicile Anvers | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_health.png",
    "seoTitle": "Kedi Oteli mi Evde Bakıcı mı Anvers | KattenHond Karşılaştırma",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_playing.png",
    "seoTitle": "Garde de Chat Vacances Anvers | Été & Noël | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_playing.png",
    "seoTitle": "Anvers Tatil Dönemi Kedi Bakıcısı | Yaz ve Noel | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_meds.png",
    "seoTitle": "Medische Kattenoppas Antwerpen | Medicatie & Zorg | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_meds.png",
    "seoTitle": "Garde Médicale Chat Anvers | Médicaments & Insuline | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_meds.png",
    "seoTitle": "Anvers Medikal Kedi Bakıcısı | İlaç ve İnsülin Bakımı | KattenHond",
...
,
  {
    ...
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Hoe lang kan een kat alleen thuis blijven? | KattenHond Antwerpen",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_feeding.png",
    "seoTitle": "How Long Can a Cat Be Left Home Alone? | KattenHond Antwerp",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Combien de Temps un Chat Peut Rester Seul? | KattenHond Anvers",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Kedi Evde Kaç Gün Yalnız Kalabilir? | KattenHond Anvers",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Pawshake & Ring Twice Alternatief Antwerpen | KattenHond Service",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Pawshake & Ring Twice Alternative Antwerp | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Alternative Pawshake & Ring Twice Anvers | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Anvers Pawshake & Ring Twice Alternatifi | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Sleuteloverdracht & Veiligheid Kattenoppas Antwerpen | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Cat Sitter Key Handover & Security Antwerp | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Remise des Clés & Sécurité Garde Chat Anvers | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Kedi Bakıcısı Anahtar Teslimi & Ev Güvenliği Anvers | KattenHond",
...
},
  {
    ...
    "excerpt": "Bent u benieuwd naar de kosten van een kattenoppas in Antwerpen? Bekijk onze transparante prijzen van €25 tot €55 per bezoek.",
    "content": "## Wat kost een kattenoppas aan huis in Antwerpen?\n\nBij het plannen van uw budget voor een vakantie wilt u weten wat de **gemiddelde prijs van een kattenoppas in Antwerpen** is.\n\n### Prijzenoverzicht bij Katten:\n\n- **Basis Pakket (€25 / bezoek):** Eten en vers water geven, kattenbak schoonmaken, korte check.\n- **Standaard Pakket (€55 / bezoek - MEEST GEKOZEN):** Inclusief borstelen, uitgebreid spelen, foto/video updates en HD Bodycam garantie.\n- **Premium Pakket (€55 / bezoek):** 2 bezoeken per dag, medicatie/insuline toedienen, planten gieten en post verzamelen.\n\nGeen verborgen inschrijfkosten of commissies! Bekijk onze volledige [Prijslijst](/nl/diensten)!",
    "date": "2026-07-23",
    "readTime": "3 min",
    "author": "KattenHond Team",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Kosten Kattenoppas Per Dag Antwerpen | Prijzen & Tarieven",
    "seoDescription": "Wat kost een kattenoppas per dag in Antwerpen? Bekijk onze transparante tarieven vanaf €25 per bezoek inclusief bodycam.",
    "locale": "nl",
    "keywords": [
...
},
  {
    ...
    "excerpt": "Curious about cat sitting rates in Antwerp? Check out our transparent pricing packages from €25 to €55 per visit.",
    "content": "## How much does in-home cat sitting cost in Antwerp?\n\nWhen budgeting for your trip, understanding **cat sitting rates in Antwerp** helps you make an informed decision.\n\n### Pricing breakdown at Katten:\n\n- **Basic Package (€25 / visit):** Feeding, fresh water, litter scooping, brief wellness check.\n- **Standard Package (€55 / visit - MOST POPULAR):** Extended play, brushing, photos & HD Bodycam recording.\n- **Premium Package (€55 / visit):** 2 daily visits, medication/insulin administration, plant watering & mail retrieval.\n\nNo subscription fees or hidden platform surcharges! See our full [Pricing](/en/diensten)!",
    "date": "2026-07-23",
    "readTime": "3 min",
    "author": "KattenHond Team",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Cat Sitter Rates Per Day Antwerp | Transparent Pricing Guide",
    "seoDescription": "How much does a cat sitter cost per day in Antwerp? Transparent daily visit rates starting at €25 with video verification.",
    "locale": "en",
    "keywords": [
...
},
  {
    ...
    "excerpt": "Découvrez les tarifs d'un garde de chat à domicile à Anvers. Nos forfaits transparents de 25€ à 55€ par visite.",
    "content": "## Quel est le prix d'un garde de chat à Anvers?\n\nConsultez nos forfaits sans frais cachés:\n- **Forfait Basique (25€ / visite)**\n- **Forfait Standard (55€ / visite - POPULAIRE)**\n- **Forfait Premium (55€ / visite - 2 visites par jour + médicaments)**\n\nConsultez nos [Tarifs](/fr/diensten)!",
    "date": "2026-07-23",
    "readTime": "3 min",
    "author": "KattenHond Team",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Prix Garde de Chat par Jour Anvers | Tarifs Katten",
    "seoDescription": "Combien coûte la garde d'un chat par jour à Anvers? Tarifs transparents dès 25€ par visite avec caméra vidéo.",
    "locale": "fr",
    "keywords": [
...
},
  {
    ...
    "excerpt": "Anvers'te evde kedi bakım ücretlerini mi merak ediyorsunuz? Ziyaret başı 25€ ile 55€ arası şeffaf paketlerimizi inceleyin.",
    "content": "## Anvers'te evde kedi bakıcılığı günlük ücretleri\n\nSeyahat bütçenizi planlarken **Anvers kedi bakıcısı fiyatlarını** bilmek önemlidir.\n\n### Katten Şeffaf Paket Fiyatları:\n\n- **Temel Paket (Ziyaret başı 25€):** Mama, su, kum temizliği ve kontrol.\n- **Standart Paket (Ziyaret başı 55€ - EN ÇOK TERCİH EDİLEN):** Oyun saati, tarama, fotoğraf/video ve Yaka Kamerası garantisi.\n- **Premium Paket (Ziyaret başı 55€):** Günde 2 ziyaret, ilaç/insülin uygulaması, saksı sulama ve posta toplama.\n\nGizli abonelik veya platform ücreti yoktur! [Fiyat Listemizi](/tr/diensten) görün!",
    "date": "2026-07-23",
    "readTime": "3 min",
    "author": "KattenHond Team",
    "image": "/images/cat_feeding.png",
    "seoTitle": "Anvers Günlük Kedi Bakıcısı Fiyatları | Ücret Rehberi | KattenHond",
    "seoDescription": "Anvers'te günlük kedi bakıcısı ne kadar? Ziyaret başı 25€'dan başlayan şeffaf fiyat paketlerimiz.",
    "locale": "tr",
    "keywords": [
...
},
  {
    ...
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_plants.png",
    "seoTitle": "Kattenbak Hygiëne & Blaasontsteking Vakantie | KattenHond Antwerpen",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_plants.png",
    "seoTitle": "Litter Box Hygiene & Cat Health on Holiday | KattenHond Antwerp",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_plants.png",
    "seoTitle": "Hygiène Litière & Santé Chat Vacances | KattenHond Anvers",
...
},
  {
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_plants.png",
    "seoTitle": "Tatilde Kedi Kumu Hijyeni & İdrar Yolu Sağlığı | KattenHond Anvers",
...
,
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Kattenoppas Merksem, Ekeren, Wilrijk & Hoboken | KattenHond",
    ...
    "keywords": [
        ...
        "kattenoppas Wilrijk",
        "kattenoppas Hoboken",
        "thuisoppas kat Antwerpen districten"
    ]
},
  {
    "id": "21-en",
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Cat Sitter Merksem, Ekeren, Wilrijk & Hoboken | KattenHond Antwerp",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Garde de Chat Merksem, Ekeren, Wilrijk & Hoboken | KattenHond",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_security.png",
    "seoTitle": "Merksem, Ekeren, Wilrijk & Hoboken Kedi Bakıcısı | KattenHond",
    ...
    "keywords": [
        ...
        "Ekeren kedi bakıcısı",
        "Wilrijk kedi bakıcısı",
        "Hoboken kedi bakıcı Anvers"
    ]
},
  {
    "id": "22-nl",
    ...
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_meds.png",
    "seoTitle": "Kattenoppas 2 Keer Per Dag Antwerpen | Premium Zorg | KattenHond",
    ...
    "locale": "nl",
    "keywords": [
        "kattenoppas 2 keer per dag Antwerpen",
        "twee bezoeken per dag kattenoppas",
        "diabetische kat 2 bezoeken Antwerpen"
    ]
},
  {
    "id": "22-en",
    ...
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_meds.png",
    "seoTitle": "Cat Sitter Twice a Day Antwerp | Double Daily Visits | KattenHond",
    ...
    "locale": "en",
    "keywords": [
        "cat sitter twice a day Antwerp",
        "two visits a day pet sitter Antwerp",
        "diabetic cat care Antwerp"
    ]
},
  {
    "id": "22-fr",
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_meds.png",
    "seoTitle": "Garde de Chat 2 Fois par Jour Anvers | KattenHond",
    "seoDescription": "Garde de chat 2 fois par jour à domicile à Anvers. Idéal pour chatons, chats âgés et diabétiques.",
    "locale": "fr",
    "keywords": [
        "garde chat 2 fois par jour Anvers",
        "visite chat matin et soir Anvers"
    ]
},
  {
    "id": "22-tr",
...
},
  {
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_plants.png",
    "seoTitle": "Kattenoppas met Planten Water Geven Antwerpen | KattenHond",
    ...
    "locale": "nl",
    "keywords": [
        "kattenoppas planten water geven Antwerpen",
        "huisoppas post ophalen Antwerpen",
        "kattenoppas kamerplanten"
    ]
},
  {
    "id": "23-en",
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_plants.png",
    "seoTitle": "Cat Sitter Plant Watering & Mail Collection Antwerp | KattenHond",
    ...
    "locale": "en",
    "keywords": [
        "cat sitter plant watering Antwerp",
        "pet sitter collect mail Antwerp",
        "house sitting cat care Antwerp"
    ]
},
  {
    "id": "23-fr",
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_plants.png",
    "seoTitle": "Garde Chat Arrosage Plantes & Courrier Anvers | KattenHond",
    ...
    "locale": "fr",
    "keywords": [
        "garde chat arrosage plantes Anvers",
        "cat sitter releve courrier Anvers"
    ]
},
  {
    "id": "23-tr",
    ...
    "author": "KattenHond Team",
    "image": "/images/cat_plants.png",
    "seoTitle": "Çiçek Sulama & Posta Toplama Dahil Kedi Bakıcısı Anvers | KattenHond",
    "seoDescription": "Anvers'te kedi bakımıyla birlikte saksı çiçeği sulama ve posta toplama hizmeti. Eviniz ve kediniz güvende.",
    "locale": "tr",
    "keywords": [
        "Anvers çiçek sulayan kedi bakıcısı",
        "Anvers kedi bakımı ev hizmeti",
        "Anvers posta toplayan bakıcı"
    ]
},
  {
    "id": "24-nl",
    ...
    "locale": "nl",
    "keywords": [
        "kattenoppas weekendje weg Antwerpen",
        "korte vakantie kattenoppas Antwerpen",
        "weekend oppas kat Antwerpen"
    ]
},
  {
    "id": "24-en",
    ...
    "locale": "en",
    "keywords": [
        "cat sitter weekend getaway Antwerp",
        "short stay cat sitter Antwerp",
        "weekend pet sitting Antwerp"
    ]
},
  {
    "id": "24-fr",
...
},
  {
    ...
    "author": "KattenHond Biologist - Bioloog",
    "image": "/images/cat_meds.png",
    "seoTitle": "Kattenoppas Medicatie & Insuline Antwerpen | KattenHond",
    ...
    "locale": "nl",
    "keywords": [
        "kat medicatie toedienen oppas Antwerpen",
        "insuline spuiten kat oppas Antwerpen",
        "medische kattenoppas Antwerpen"
    ]
},
  {
    ...
    "author": "KattenHond Biologist - Biologist",
    "image": "/images/cat_meds.png",
    "seoTitle": "Medication & Insulin Cat Sitter Antwerp | KattenHond",
    ...
    "keywords": [
        ...
        "cat insulin injection sitter Antwerp",
        "special care pet sitter Antwerp"
    ]
},
  {
    "id": "25-fr",
    ...
    "author": "KattenHond Biologist - Biologiste",
    "image": "/images/cat_meds.png",
    "seoTitle": "Garde Chat Médicaments & Insuline Anvers | KattenHond",
    ...
    "locale": "fr",
    "keywords": [
        "donner medicament chat garde Anvers",
        "insuline chat cat sitter Anvers"
    ]
},
  {
    "id": "25-tr",
    ...
    "author": "KattenHond Biologist - Biyolog",
    "image": "/images/cat_meds.png",
    "seoTitle": "İlaç ve İnsülin İğnesi Yapan Kedi Bakıcısı Anvers | KattenHond",
    ...
    "locale": "tr",
    "keywords": [
        "Anvers kedi ilaç verme bakıcısı",
        "Anvers kedi insülin iğnesi bakıcı",
        "Anvers medikal kedi bakımı"
    ]
}
,
  ...
  {
    "id": "26-nl",
    "slug": "kattenoppas-en-hondenoppas-in-willebroek-en-rupelstreek",
    "title": "Kattenoppas en Hondenoppas in Willebroek & de Rupelstreek: De Beste Thuiszorg",
    "excerpt": "Zoekt u een betrouwbare dierenoppas in Willebroek, Blaasveld of Tisselt? Ontdek waarom KattenHond de nummer 1 keuze is voor katten en honden.",
    "content": "## Professionele Huisdierenoppas in Willebroek (2830) en Omgeving\n\nWanneer u in **Willebroek (2830)**, **Blaasveld**, **Tisselt**, **Heindonk** of **Klein-Willebroek** woont en op vakantie gaat of lange werkdagen maakt, wilt u de allerbeste zorg voor uw viervoeter.\n\nVeel huisdiereigenaren twijfelen tussen een traditioneel dierenpension of een oppas aan huis. Als biologen en dierengedragsexperts bij **KattenHond** zien we dat dieren in hun vertrouwde woning aanzienlijk minder stress ervaren.\n\n### Waarom kiezen baasjes in Willebroek voor KattenHond?\n\n1. **Vertrouwde Omgeving:** Uw kat of hond blijft lekker in zijn eigen mand en tuin. Geen blaffende kennels of vreemde geuren.\n2. **100% HD Bodycam Garantie:** Elk bezoek wordt vastgelegd met een discrete bodycam. U ziet precies hoe uw dier verzorgd en geknuffeld wordt.\n3. **Biologische Expertise:** Deskundige toediening van voeding, medicatie en diabetes-insuline zonder dwang.\n4. **Hondenuitlaatservice:** Individuele wandelingen langs het Zeekanaal of in de lokale parken.\n5. **Gratis Woningdiensten:** Wij geven uw planten water en legen de brievenbus tegen inbraakpreventie.\n\nWilt u zorgeloos reizen? Bekijk onze [Diensten in Willebroek](/nl/diensten/willebroek) of neem direct [Contact](/nl/contact) op voor een gratis kennismakingsgesprek aan huis!",
    "date": "2026-08-27",
    "readTime": "3 min",
    "author": "KattenHond Biologist",
    "image": "/images/cat_bodycam.png",
    "seoTitle": "Kattenoppas & Hondenoppas Willebroek (2830) | KattenHond",
    "seoDescription": "Professionele kattenoppas en hondenoppas aan huis in Willebroek (2830), Blaasveld en Tisselt. 100% HD Bodycam videobewijs en bioloog toezicht.",
    "locale": "nl",
    "keywords": [
  ...
  {
    "id": "26-en",
    "slug": "cat-and-dog-sitter-in-willebroek-rupel-region",
    "title": "In-Home Cat Sitter & Dog Sitting in Willebroek & Rupel Region: Premier Pet Care",
    "excerpt": "Searching for a trusted pet sitter in Willebroek, Blaasveld or Tisselt? Discover why KattenHond is the top choice for cats and dogs.",
    "content": "## Premium In-Home Pet Care in Willebroek (2830)\n\nIf you live in **Willebroek (2830)**, **Blaasveld**, **Tisselt**, or **Klein-Willebroek**, ensuring your furry family members receive attentive care while you are traveling is essential.\n\nAt **KattenHond**, our biologist-led team provides dedicated in-home cat visits and solo dog walking sessions.\n\n### Key Advantages for Willebroek Pet Owners:\n- **Zero Boarding Stress:** Your pets stay relaxed in their known territory.\n- **100% HD Bodycam Proof:** Watch transparent video logs of every single visit.\n- **Medical Expertise:** Medication and insulin shots administered gently.\n- **Dog Walking Service:** Personalized outdoor walks around local green paths.\n- **Complimentary House Sitting:** Mail retrieval and indoor plant watering included free.\n\nBook your free meet and greet via our [Willebroek Service Page](/en/diensten/willebroek) or [Contact Us](/en/contact)!",
    "date": "2026-08-27",
    "readTime": "3 min",
    "author": "KattenHond Biologist",
    "image": "/images/cat_bodycam.png",
    "seoTitle": "Cat Sitter & Dog Sitting Willebroek (2830) | KattenHond",
    "seoDescription": "Verified in-home cat sitting and dog walking in Willebroek (2830), Blaasveld & Tisselt. 100% HD bodycam verified visits.",
    "locale": "en",
    "keywords": [
      "cat sitter Willebroek",
      "dog sitting Willebroek",
      "pet sitter Willebroek 2830",
      "dog walker Willebroek"
    ]
  },
  {
    "id": "26-fr",
    "slug": "garde-de-chat-et-chien-a-domicile-willebroek",
    "title": "Garde de Chat et Chien à Domicile à Willebroek (2830) : Soins d'Excellence",
    "excerpt": "Vous cherchez une garde d'animaux de confiance à Willebroek, Blaasveld ou Tisselt ? Découvrez les services KattenHond.",
    "content": "## Garde d'animaux professionnelle à domicile à Willebroek (2830)\n\nPour vos vacances ou déplacements professionnels, **KattenHond** assure des visites à domicile et des promenades canines à **Willebroek**, **Blaasveld** et **Tisselt**.\n\n- **Confort à domicile sans stress de chenil.**\n- **Garantie vidéo 100% HD Bodycam.**\n- **Surveillance de santé par des biologistes.**\n- **Arrosage des plantes et relève de courrier offerts.**\n\n[Contactez-nous](/fr/contact) pour planifier votre première visite !",
    "date": "2026-08-27",
    "readTime": "3 min",
    "author": "KattenHond Biologiste",
    "image": "/images/cat_bodycam.png",
    "seoTitle": "Garde Chat & Chien Willebroek (2830) | KattenHond",
    "seoDescription": "Garde professionnelle de chats et chiens à domicile à Willebroek (2830). Enregistrement vidéo HD et expertise biologique.",
    "locale": "fr",
    "keywords": [
  ...
  {
    "id": "26-tr",
    "slug": "willebroek-evde-kedi-ve-kopek-bakicisi",
    "title": "Willebroek (2830) Bölgesinde Profesyonel Evde Kedi ve Köpek Bakımı",
    "excerpt": "Willebroek, Blaasveld veya Tisselt'te güvenilir evcil hayvan bakıcısı mı arıyorsunuz? KattenHond ile yaka kameralı üstün hizmet.",
    "content": "## Willebroek ve Rupel Bölgesinde Evde Kedi & Köpek Bakıcılığı\n\n**Willebroek (2830)**, **Blaasveld**, **Tisselt** ve çevresinde yaşayan hayvanseverler için **KattenHond**, evcil hayvanlarınıza otel stresi yaşatmadan kendi evinizde bakar.\n\n### Willebroek Hizmet Avantajlarımız:\n1. **Pansiyon Stresi Yok:** Kediniz veya köpeğiniz kendi yatağında huzurla kalır.\n2. **%100 HD Yaka Kamerası:** Her ziyarette video kaydı ile tam şeffaflık.\n3. **Biyolog Denetimi:** İlaç, mama ve sağlık kontrolü profesyonelce yapılır.\n4. **Köpek Gezdirme Servisi:** Birebir enerjik yürüyüş seansları.\n5. **Ücretsiz Ekstralar:** Çiçekleriniz sulanır, postalarınız toplanır.\n\nHemen [İletişim Formumuzdan](/tr/contact) veya [Willebroek Sayfamızdan](/tr/diensten/willebroek) ücretsiz randevu oluşturun!",
    "date": "2026-08-27",
    "readTime": "3 min",
    "author": "KattenHond Biyolog",
    "image": "/images/cat_bodycam.png",
    "seoTitle": "Willebroek Kedi ve Köpek Bakıcısı (2830) | KattenHond",
    "seoDescription": "Willebroek (2830) bölgesinde profesyonel evde kedi bakımı ve köpek gezdirme hizmeti. Yaka kamerası garantili ve biyolog denetimli.",
    "locale": "tr",
    "keywords": [
      "Willebroek kedi bakıcısı",
      "Willebroek köpek bakıcısı",
      "Willebroek köpek gezdirme",
      "Belçika pet sitter"
    ]
  },
  {
    "id": "27-nl",
    "slug": "hondenuitlaatservice-en-hondenoppas-antwerpen-prijzen-en-tips",
    "title": "Hondenuitlaatservice en Hondenoppas aan Huis in Antwerpen: Tarieven en Tips",
    "excerpt": "Hoe werkt een professionele hondenuitlaatservice in Antwerpen? Ontdek wat de voordelen zijn van 1-op-1 wandelingen en thuisoppas.",
    "content": "## De voordelen van een individuele hondenuitlaatservice in Antwerpen\n\nHeeft u een drukke baan of moeite met lange wandelingen? Een **hondenuitlaatservice aan huis** biedt de ideale uitkomst voor uw trouwe viervoeter.\n\n### Individuele wandeling vs. Roedelwandeling in grote busjes\nVeel traditionele uitlaatdiensten stoppen 10 tot 15 honden in een busje. Dit zorgt voor reisstress, risico op onderlinge gevechten en wagenziekte.\n\nBij **KattenHond** kiezen we bewust voor **individuele of duo-wandelingen**:\n- **100% Persoonlijke Aandacht:** We wandelen direct vanuit uw eigen voordeur in vertrouwde parken.\n- **GPS-Route & HD Bodycam:** U ontvangt na afloop de gelopen route en vrolijke actiefoto's.\n- **Pootjes Schoonmaken:** Bij thuiskomst drogen we de pootjes af en voorzien we fris drinkwater.\n\nBekijk direct onze [Hondenuitlaatservice Tarieven](/nl/diensten/hondenuitlaatservice) of boek een [Hondenoppas](/nl/diensten/hondenoppas)!",
    "date": "2026-08-27",
    "readTime": "4 min",
    "author": "KattenHond Team",
    "image": "/images/cat_playing.png",
    "seoTitle": "Hondenuitlaatservice Antwerpen & Tarieven | KattenHond",
    "seoDescription": "Professionele hondenuitlaatservice en hondenoppas aan huis in Antwerpen. Individuele wandelingen, GPS-route en HD Bodycam beelden.",
    "locale": "nl",
    "keywords": [
      "hondenuitlaatservice Antwerpen",
      "hondenoppas Antwerpen",
      "hond uitlaten tarieven",
      "dog walker Antwerpen"
    ]
  },
  {
    "id": "27-en",
    "slug": "dog-walking-service-and-sitting-antwerp-prices-and-guide",
    "title": "Dog Walking Service & In-Home Dog Sitting in Antwerp: Complete Guide & Rates",
    "excerpt": "How does a professional dog walking service operate in Antwerp? Learn the key benefits of solo walks and in-home dog sitting.",
    "content": "## Why Solo Dog Walking in Antwerp is the Safest Option for Your Pet\n\nBusy schedule or long office hours in Antwerp? A professional **in-home dog walker** keeps your canine active, happy, and well-exercised.\n\n### Solo Walks vs Overcrowded Dog Vans\nUnlike group walking vans where dogs spend hours locked in transit, **KattenHond** walks your dog 1-on-1 right from your doorstep in local Antwerp parks.\n\n- **Safe, Focused Attention:** Tailored to your dog's energy level and age.\n- **GPS Route & HD Video Proof:** See exact route details and fun video clips.\n- **Clean Paws & Fresh Water:** Complete care before leaving your home secure.\n\nExplore our [Dog Walking Service](/en/diensten/hondenuitlaatservice) and [In-Home Dog Sitting](/en/diensten/hondenoppas)!",
    "date": "2026-08-27",
    "readTime": "4 min",
    "author": "KattenHond Team",
    "image": "/images/cat_playing.png",
    "seoTitle": "Dog Walking Service Antwerp & Rates | KattenHond",
    "seoDescription": "Professional dog walking and in-home dog sitting in Antwerp. 1-on-1 walks with GPS tracking and HD bodycam video proof.",
    "locale": "en",
    "keywords": [
      "dog walking service Antwerp",
      "dog sitter Antwerp",
      "hire dog walker Flanders",
      "dog sitting rates Antwerp"
    ]
  },
  {
    "id": "27-fr",
    "slug": "service-promenade-de-chien-et-garde-anvers-tarifs",
    "title": "Service de Promenade de Chien & Garde à Domicile à Anvers : Guide et Tarifs",
    "excerpt": "Comment fonctionne une promenade de chien individuelle à Anvers ? Découvrez les avantages de notre service personnalisé.",
    "content": "## Promenade individuelle de chien à Anvers : Sécurité et Bien-être\n\nVotre emploi du temps ne vous permet pas de sortir votre chien en journée ? **KattenHond** propose des promenades individuelles adaptées à ses besoins.\n\n- **Promenades en tête-à-tête (aucun transport en fourgonnette bruyante).**\n- **Parcours GPS et photos envoyés sur votre smartphone.**\n- **Pattes essuyées et écuelle d'eau fraîche à chaque passage.**\n\nDécouvrez notre [Service de Promenade pour Chien](/fr/diensten/hondenuitlaatservice) !",
    "date": "2026-08-27",
    "readTime": "4 min",
    "author": "KattenHond Team",
    "image": "/images/cat_playing.png",
    "seoTitle": "Promenade Chien Anvers & Garde à Domicile | KattenHond",
    "seoDescription": "Promeneur de chien professionnel à Anvers et garde canine à domicile. Promenades individuelles avec suivi GPS et vidéos HD.",
    "locale": "fr",
    "keywords": [
      "promeneur chien Anvers",
      "service promenade chien",
      "garde chien Anvers tarifs"
    ]
  },
  {
    "id": "27-tr",
    "slug": "anvers-kopek-gezdirme-ve-evde-kopek-bakimi-fiyatlari",
    "title": "Anvers'te Profesyonel Köpek Gezdirme ve Evde Köpek Bakımı Rehberi",
    "excerpt": "Anvers'te köpek gezdirme servisi nasıl çalışır? Birebir yürüyüşlerin ve evde köpek bakıcılığının avantajları nelerdir?",
    "content": "## Anvers'te Bireysel Köpek Gezdirme ve Evde Bakım Hizmeti\n\nİş temposu veya seyahatler nedeniyle köpeğinizi evde uzun saatler yalnız bırakmak istemiyorsanız, **KattenHond Köpek Gezdirme Servisi** tam size göre.\n\n### Birebir Yürüyüşün Önemi:\n- **Kalabalık Minibüs Yok:** Köpeğinizi saatlerce araçta tutmak yerine doğrudan kapınızdan çıkarıp mahallenizdeki parklarda gezdiriyoruz.\n- **GPS Rotası ve HD Video:** Yürüyüş güzergahını ve sevimli anları anında telefonunuza iletiyoruz.\n- **Pati Temizliği ve Su:** Eve dönüşte patilerini silip taze suyunu veriyoruz.\n\nHemen [Köpek Gezdirme Hizmetimizi](/tr/diensten/hondenuitlaatservice) ve [Evde Köpek Bakımını](/tr/diensten/hondenoppas) inceleyin!",
    "date": "2026-08-27",
    "readTime": "4 min",
    "author": "KattenHond Ekibi",
    "image": "/images/cat_playing.png",
    "seoTitle": "Anvers Köpek Gezdirme Servisi ve Fiyatları | KattenHond",
    "seoDescription": "Anvers'te profesyonel köpek gezdirme ve evde köpek bakıcılığı. Bireysel yürüyüşler, GPS takibi ve HD kamera kayıtları.",
    "locale": "tr",
    "keywords": [
      "Anvers köpek gezdirme",
      "Anvers köpek bakıcısı",
